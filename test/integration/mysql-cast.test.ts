...
describe('Mysql BigInt Cast', () => {
  ...
  if (isMysql()) {
    it('Works All Columns Types', async () => {
      ...
      expect(row.binary).toEqual(
        Buffer.concat([Buffer.from('1'), Buffer.from([0x00, 0x00])]),
      );
      ...
      expect(row.float).toBe(
        '12345678906183670000000000000000000.000000000000000000000000000000',
      );
      expect(row.double).toBe(
        '12345678901234570000000000000000000.000000000000000000000000000000',
      );
      ...
      expect(row.decimal_zero).toBe(
        '00000000000000000000000000000000001.200000000000000000000000000000',
      );
      expect(row.dec_zero).toBe(
        '00000000000000000000000000000000001.300000000000000000000000000000',
      );
      expect(row.float_zero).toBe(
        '0000000000000000000000000000000001.399999976158142000000000000000',
      );
      expect(row.double_zero).toBe(
        '0000000000000000000000000000000001.500000000000000000000000000000',
      );
      expect(row.double_precision_zero).toBe(
        '0000000000000000000000000000000001.600000000000000000000000000000',
      );
      expect(row.date).toBe(
        isMariaGreaterThen1009() ? '2023-01-01 00:00:00' : '2023-01-01',
      );
    ...
    it('Works All Columns Types', async () => {
      ...
      expect(row.numeric).toBe(
        '12345678901234567890123456789012345.123456789012345678901234567890',
      );
      expect(row.fixed).toBe(
        '12345678901234567890123456789012345.123456789012345678901234567890',
      );
